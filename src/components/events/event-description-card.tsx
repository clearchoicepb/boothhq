    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900">Staffing Notes</h2>
        ...
        <textarea
          ...
          rows={6}
          placeholder="Enter staffing notes..."
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <p className="text-sm text-gray-700 whitespace-pre-wrap">
        {description || <span className="text-gray-400 italic">No staffing notes set</span>}
      </p>
    </div>
  )
}
