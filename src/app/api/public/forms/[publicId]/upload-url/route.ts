...
const log = createLogger('api:public:forms:upload-url')
...
/**
 * POST /api/public/forms/[publicId]/upload-url
 * Generate a pre-signed upload URL for file uploads on public forms
 */
export async function POST(
  ...
  try {
    ...
    // Only allow uploads for sent or viewed forms (not draft or completed)
    ...
    const storagePath = `${form.tenant_id}/form-uploads/event-forms/${form.id}/${fieldId}/${safeFileName}`
    ...
    log.info({ publicId, fieldId, storagePath }, 'Generated upload URL for form')
