...
export async function PUT(
  ...
  try {
    ...
    log.debug({ paymentId: id }, 'Updating payment')
...
export async function DELETE(
  ...
  try {
    ...
    log.debug({ paymentId: id }, 'Deleting payment')
...
async function recalculateInvoiceFromPayments(
  ...
  if (updateError) {
    ...
    log.debug({ invoiceId, paid: totalPaid, balance: balanceAmount, status: newStatus }, 'Invoice recalculated')
  }
}
