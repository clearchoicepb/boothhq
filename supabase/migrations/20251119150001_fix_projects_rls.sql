...
DROP POLICY IF EXISTS "Allow all access to project_team_members" ON project_team_members;
...
-- IMPORTANT: Need both USING and WITH CHECK clauses for INSERT/UPDATE
