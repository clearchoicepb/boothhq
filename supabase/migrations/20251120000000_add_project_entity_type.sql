-- Add 'project' and 'ticket' to entity_type constraints for attachments and notes tables
-- This allows projects and tickets to have attachments and notes
...
CHECK (entity_type IN ('opportunity', 'account', 'contact', 'lead', 'invoice', 'event', 'project', 'ticket'));
...
CHECK (entity_type IN ('lead', 'account', 'contact', 'opportunity', 'event', 'invoice', 'project', 'ticket'));
